...
const SOCIAL_LINKS = [
  {
    name: 'GitHub',
    link: 'https://github.com/jb9dev/won_games_api',
  },
  {
    name: 'Slack',
  ...
  {
    name: 'Twitter',
    link: 'https://twitter.com/__JeanBarbosa',
  }
];
        ...
        <div className="row">
          <div className="col-lg-8 col-md-12">
            <Block>
              ...
              <P>No menu lateral à esquerda você pode inserir diferentes jogos, categorias e publishers à loja de jogos!</P>
          ...
          <div className="col-md-12 col-lg-4">
            <Block style={{ paddingRight: 30, paddingBottom: 0 }}>
              ...
              <P style={{ marginTop: 7, marginBottom: 0 }}>
                Em caso de dúvidas e/ou sugestões, só ir em algum dos links abaixo =)
              </P>
              <ALink
